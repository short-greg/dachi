...
class TestGetOrSpawn(object):
    ...
    def test_get_or_spawn_doesnt_spawn_new_state(self):
        ...
        state = {'child': {}}
        target = state['child']
        child = _data.get_or_spawn(state, 'child')
    ...
    def test_get_or_spawn_spawns_new_state(self):
        ...
        state = {'child': {}}
        target = state['child']
        child = _data.get_or_spawn(state, 'other')
