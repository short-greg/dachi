...
# Commented out - submit_rest method not implemented in AsyncDispatcher
@pytest.mark.skip(reason="submit_rest method not implemented")  
class TestSubmitRest:

    def test_submit_rest_as_json_true(self, rd: AsyncDispatcher, monkeypatch: pytest.MonkeyPatch):
        class FakeResponse:
            status_code = 200
            headers = {"X-Test": "1"}
            text = "ok"
    ...
    def test_submit_rest_as_json_false(self, rd: AsyncDispatcher, monkeypatch: pytest.MonkeyPatch):
        class FakeResponse:
            status_code = 201
            headers = {"X-Other": "2"}
            text = "created"
    ...
    def test_submit_rest_json_decode_error_sets_error(self, rd: AsyncDispatcher, monkeypatch: pytest.MonkeyPatch):
        class FakeResponse:
            status_code = 200
            headers = {}
            text = "ok"
    ...
    def test_submit_rest_request_exception_sets_error(self, rd: AsyncDispatcher, monkeypatch: pytest.MonkeyPatch):
        def fake_request(method, url, **kwargs):
