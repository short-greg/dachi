...
# local
from ..core import Storable, Renderable, BaseModule, ModuleList
...
def parallel_loop(
    modules: typing.Union['ModuleList', Process, None], *args, **kwargs
) -> typing.Iterator[
...
class AsyncParallel(Process):
    ...
    async def aforward(self, *args, **kwargs) -> typing.List:
        ...
        async with asyncio.TaskGroup() as tg:
            for module, cur_args, cur_kwargs in parallel_loop(
...
# class ParallelModule(Process, ABC):
#     """Module that allows 
#     """
...
#     def __init__(
#         self, module: Process, *args, **kwargs
#     ):
...
#     def _exec(self, module: Process, *args, **kwargs):
...
#     def __init__(self, module: StreamProcess,  *args, **kwargs):
...
#     def _stream_exec(self, module: StreamProcess, *args, **kwargs):
#         """Stream the module
...
#                 yield v
#             if recurse and isinstance(v, BaseProcess):
...
# class ModuleList(Process):
#     """Use to have a list of modules
#     """

#     def __init__(self, modules: typing.List[Process]):
...
#     def children(self, recurse: bool = True) -> typing.Iterator[Process]:
