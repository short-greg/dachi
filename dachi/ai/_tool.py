...
class Tool(core.Module, pydantic.BaseModel):
    ...
    def to_openai(self) -> typing.Dict:
        # Converts the tool to a format to use for
        # OpenAI
        pass
...
class ToolSet(pydantic.BaseModel, core.Module):
    ...
    name: str
    tools: typing.Dict[str, Tool] = pydantic.Field(default_factory=dict, description="A dictionary of tools to use for an agent.")
